  ...
  const carouselItems = [
    {
      ...
      description: 'Latest breakthroughs in pharmaceutical research and development.',
    },
    {
      id: 2,
      ...
      description: 'Herbal medicine and traditional remedies for well-being.',
    },
    {
      id: 3,
      ...
      description: 'The integration of conventional and alternative medicine.',
    },
  ];

  return (
    <div className="mx-0 py-8 mb-5 h-50">
